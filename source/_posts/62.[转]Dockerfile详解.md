...
本文转自 [看完这篇,再也不用担心不会写dockerfile了](https://segmentfault.com/a/1190000038194699?hmsr=toutiao.io&utm=&utm_medium=toutiao.io&utm_source=toutiao.io)
...
比如 ADD [http://example.com/config.pro...](http://example.com/config.property) / 会创建文件/config.property。
