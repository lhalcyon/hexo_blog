...
title: 转-H5端页面可见监听
date: 2018/12/26
permalink: h5-visibility-listen
tags: [Javascript,H5]
categories: 
- Javascript
---
...
{% note info %}
 ...
 Android , iOS 均有提供页面可见/不可见的回调方法,通常在其中订阅和取消订阅. 本文将说明如何在H5中监听页面可见状态. 

[转载原文](https://blog.csdn.net/itKingOne/article/details/83616429)
...
一般我们在进行前端页面开发时,对于用户正在离开页面.常用的方法是监听下面三个事件.
...
官方有个在线的例子大伙可以看一下：http://daniemon.com/tech/webapps/page-visibility/
